...
public class Complex {
	...
	public Complex negate() {
		return of(this.getReal().negate(), this.getImaginary().negate());
	}
	...
	public Complex invert() {
		...
		return of(this.getReal().divide(magnitude), this.getImaginary().divide(magnitude).negate());
	}

	public Complex conjugate() {
		return of(this.getReal(), this.getImaginary().negate());
	}

	public Complex add(Complex other) {
		return of(this.getReal().add(other.getReal()), this.getImaginary().add(other.getImaginary()));
	}

	public Complex subtract(Complex other) {
		return of(this.getReal().subtract(other.getReal()), this.getImaginary().subtract(other.getImaginary()));
	}
	...
	public Complex multiply(Real other) {
		return of(this.getReal().multiply(other), this.getImaginary().multiply(other));
	}
	...
	public Complex divide(Real other) {
		return of(this.getReal().divide(other), this.getImaginary().divide(other));
	}
